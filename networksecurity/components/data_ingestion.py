...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe:pd.DataFrame):
        try:
            ...
            logging.info("Exited split_data_as_tran_test method of data_ingestion class")
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            dataingestionartifact=DataIngestionArtifacts(train_file_path=self.data_ingestion_config.trainig_file_path, test_file_path=self.data_ingestion_config.testing_file_path)
