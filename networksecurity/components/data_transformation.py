...
class DataTransformation:
    ...
    def get_data_transformer_object(cls):
        """
        it initiates a KNNImpute object with the parameters specified in the training_pipeline.py file
        ...
        try:
            ...
            logging.info(
                f"initializes KNNImputer with {DATA_TRANSFORMATION_IMPUTER_PARAMS}"
            )
    ...
    def initiate_data_transformation(self)->DataTransformationArtifacts:
        ...
        try:
            ...
            save_numpy_array_data(self.data_transformation_config.tranformed_train_file_path, array=train_arr)
            save_numpy_array_data(self.data_transformation_config.transformed_test_file_path,array=test_arr)
            save_object(self.data_transformation_config.tranformed_object_file_path, preprocessor_obj)
