...
class TrainingPipeline:
    ...
    def sync_artifact_dir_to_s3(self):
        try:
            ...
            s3_sync = S3Sync()
            s3_sync.sync_folder_to_s3(folder= self.training_pipeline_config.artifact_dir, aws_bucket_url=aws_bucket_url)
        except Exception as e:
            raise NetworkSecurityException(e,sys)
    ...
    def sync_saved_model_dir_to_s3(self):
        try:
            ...
            s3_sync = S3Sync()
            s3_sync.sync_folder_to_s3(folder=self.training_pipeline_config.model_dir, aws_bucket_url=aws_bucket_url)
        except Exception as e:
            raise NetworkSecurityException(e,sys)
